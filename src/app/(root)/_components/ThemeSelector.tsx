  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <motion.button 
        ...
        className="w-48 group relative flex items-center gap-2 px-4 py-2.5 bg-[#1e1e2e]/80 hover:bg-[#3f2d48] 
        rounded-lg transition-all duration-200 border border-gray-800/50 hover:border-gray-700"
      >
        {/* hover state decorator */}
          ...
          >
            ...
            {THEMES.map((t,index) => (
              <motion.button
                ...
                className={`
                relative group w-full flex items-center gap-3 px-3 py-2.5 hover:bg-[#322637] transition-all duration-200
                ${theme === t.id ? "bg-purple-500/10 text-purple-400" : "text-gray-300"}
              `}
              ...
              >
                ...
                <div
                  ...
                  ${theme === t.id ? "bg-purple-500/10 text-purple-400" : "bg-gray-800/50 text-gray-400"}
