...
function Footer() {
  return (
    <footer className="relative border-t border-white/50 mt-auto">
      <div className="absolute inset-x-0 -top-px h-px bg-gradient-to-r from-transparent via-pruple-900 to-transparent" />
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-gray-400">
            <AppWindowMac className="size-5" />
            <span>Easing your development journey, step by step</span>
          </div>
